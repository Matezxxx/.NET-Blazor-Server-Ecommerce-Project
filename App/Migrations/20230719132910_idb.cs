        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandLogoName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Size = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    MIMEType = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandLogos", x => x.BrandLogoId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Brands_BrandLogos_BrandLogoId",
                        column: x => x.BrandLogoId,
                        principalTable: "BrandLogos",
